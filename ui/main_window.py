...
class TTSMainWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        layout.addWidget(QLabel("Instructions (optional):"))
        self.instruct_edit = QTextEdit()
        self.instruct_edit.setMaximumHeight(80)
        self.instruct_edit.setPlaceholderText("Enter instructions to control voice style, emotion, pace, etc. (e.g., 'slow, emotional, natural')")
    ...
    def load_model(self):
        self.status_label.setText("Loading model... This may take a minute...")
        self.progress_bar.setVisible(True)
    ...
    def on_history_clicked(self, item):
        ...
        if idx < len(self.history):
            ...
            # Load instruct
            if entry.get('instruct'):
                self.instruct_edit.setPlainText(entry['instruct'])
            else:
